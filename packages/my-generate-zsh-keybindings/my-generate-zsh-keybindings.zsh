...
# Navigation
widget_info[beginning-of-line]="navigation|Go to BOL"
widget_info[end-of-line]="navigation|Go to EOL"
widget_info[forward-char]="navigation|Move fwd one char"
widget_info[backward-char]="navigation|Move bwd one char"
widget_info[forward-word]="navigation|Move fwd one word"
widget_info[backward-word]="navigation|Move bwd one word"
widget_info[vi-forward-word]="navigation|Move fwd one word (vi-style)"
widget_info[vi-forward-word-end]="navigation|Move to end of word (vi-style)"
widget_info[vi-backward-word]="navigation|Move bwd one word (vi-style)"
widget_info[emacs-forward-word]="navigation|Move fwd one word (emacs-style)"
widget_info[emacs-backward-word]="navigation|Move bwd one word (emacs-style)"
widget_info[vi-find-next-char]="navigation|Find next char"
widget_info[vi-find-prev-char]="navigation|Find previous char"
widget_info[vi-goto-column]="navigation|Go to column"
widget_info[vi-first-non-blank]="navigation|Go to first non-blank char"
widget_info[vi-end-of-line]="navigation|Go to EOL (vi-style)"
widget_info[vi-forward-blank-word]="navigation|Move fwd one WORD"
widget_info[vi-forward-blank-word-end]="navigation|Move to end of WORD"
widget_info[vi-backward-blank-word]="navigation|Move bwd one WORD"
widget_info[vi-match-bracket]="navigation|Go to matching bracket"
widget_info[vi-repeat-find]="navigation|Repeat char find"
widget_info[vi-rev-repeat-find]="navigation|Reverse repeat char find"
...
widget_info[history-search-backward]="history|Search bwd in history"
widget_info[history-search-forward]="history|Search fwd in history"
widget_info[history-beginning-search-backward]="history|Search bwd from current input"
widget_info[history-beginning-search-forward]="history|Search fwd from current input"
...
widget_info[history-incremental-search-backward]="history|Incremental search bwd (Ctrl+R)"
widget_info[history-incremental-search-forward]="history|Incremental search fwd (Ctrl+S)"
...
# Editing
widget_info[kill-line]="editing|Kill from cursor to EOL"
widget_info[backward-kill-line]="editing|Kill from cursor to BOL"
widget_info[kill-whole-line]="editing|Kill entire line"
widget_info[kill-word]="editing|Kill word fwd"
widget_info[backward-kill-word]="editing|Kill word bwd"
widget_info[kill-buffer]="editing|Kill entire buffer"
widget_info[backward-delete-char]="editing|Delete char bwd"
widget_info[delete-char]="editing|Delete char fwd"
widget_info[delete-char-or-list]="editing|Delete char or list completions"
widget_info[delete-word]="editing|Delete word fwd"
widget_info[backward-delete-word]="editing|Delete word bwd"
widget_info[yank]="editing|Yank (paste) killed text"
widget_info[yank-pop]="editing|Cycle through kill ring"
widget_info[quoted-insert]="editing|Insert next char literally"
widget_info[transpose-chars]="editing|Transpose chars"
...
widget_info[vi-change-eol]="editing|Change to EOL (vi C)"
widget_info[vi-change-whole-line]="editing|Change entire line (vi cc)"
widget_info[vi-delete]="editing|Delete (vi d)"
widget_info[vi-delete-char]="editing|Delete char under cursor (vi x)"
widget_info[vi-backward-delete-char]="editing|Delete char before cursor (vi X)"
widget_info[vi-kill-line]="editing|Kill to BOL (vi)"
widget_info[vi-kill-eol]="editing|Kill to EOL (vi)"
...
widget_info[vi-yank-eol]="editing|Yank to EOL (vi Y)"
widget_info[vi-replace]="editing|Replace char (vi r)"
...
widget_info[autopair-delete]="editing|Delete char bwd (autopair)"
widget_info[autopair-delete-word]="editing|Delete word bwd (autopair)"
...
widget_info[menu-complete]="completion|Cycle through completions fwd"
widget_info[reverse-menu-complete]="completion|Cycle through completions bwd"
...
ignore_widgets[autopair-insert]=1
ignore_widgets[autopair-close]=1
